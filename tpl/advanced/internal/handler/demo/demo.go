...
func (d *DemoHandler) Login(ctx *gin.Context) {
	req := &struct {
...
func (d *DemoHandler) Refresh(ctx *gin.Context) {
	req := &struct {
...
func (d *DemoHandler) Info(ctx *gin.Context) {
...
func (d *DemoHandler) Logout(ctx *gin.Context) {
...
func (d *DemoHandler) SubmitCsrf(ctx *gin.Context) {
...
func (d *DemoHandler) SSE(ctx *gin.Context) {
...
func (d *DemoHandler) WSTicket(ctx *gin.Context) {
...
func (d *DemoHandler) WS(ctx *gin.Context) {

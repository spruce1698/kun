...
var (
    ...
    CmdCreate = &cobra.Command{
        ...
        Short:   "Create a new ctrl/svc/cs/db/cache",
...
func init() {
    ...
    CmdCreateCAndS.Flags().StringVarP(&tplPath, "tpl-path", "t", tplPath, "template path")
}
